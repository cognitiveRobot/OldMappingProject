...
${OBJECTDIR}/src/AutonomousXplorationAndMapping.o: src/AutonomousXplorationAndMapping.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AutonomousXplorationAndMapping.o src/AutonomousXplorationAndMapping.cpp

${OBJECTDIR}/src/CompareASR.o: src/CompareASR.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CompareASR.o src/CompareASR.cpp

${OBJECTDIR}/src/CompareASRClass.o: src/CompareASRClass.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CompareASRClass.o src/CompareASRClass.cpp

${OBJECTDIR}/src/Comparison.o: src/Comparison.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Comparison.o src/Comparison.cpp

${OBJECTDIR}/src/ExploringandReturn.o: src/ExploringandReturn.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ExploringandReturn.o src/ExploringandReturn.cpp

${OBJECTDIR}/src/GXplorationAndMapping.o: src/GXplorationAndMapping.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GXplorationAndMapping.o src/GXplorationAndMapping.cpp

${OBJECTDIR}/src/GeometricOp.o: src/GeometricOp.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GeometricOp.o src/GeometricOp.cpp

${OBJECTDIR}/src/GeometryFuncs.o: src/GeometryFuncs.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GeometryFuncs.o src/GeometryFuncs.cpp

${OBJECTDIR}/src/GroupS.o: src/GroupS.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GroupS.o src/GroupS.cpp

${OBJECTDIR}/src/GuidedXplorationAndMapping.o: src/GuidedXplorationAndMapping.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GuidedXplorationAndMapping.o src/GuidedXplorationAndMapping.cpp

${OBJECTDIR}/src/Laser2Surface.o: src/Laser2Surface.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Laser2Surface.o src/Laser2Surface.cpp
...
${OBJECTDIR}/src/Mapping.o: src/Mapping.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Mapping.o src/Mapping.cpp

${OBJECTDIR}/src/Minfo.o: src/Minfo.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Minfo.o src/Minfo.cpp

${OBJECTDIR}/src/NavigationToExit.o: src/NavigationToExit.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/NavigationToExit.o src/NavigationToExit.cpp
...
${OBJECTDIR}/src/OfflineNavigationToExit.o: src/OfflineNavigationToExit.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/OfflineNavigationToExit.o src/OfflineNavigationToExit.cpp

${OBJECTDIR}/src/PathPlanning.o: src/PathPlanning.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PathPlanning.o src/PathPlanning.cpp

${OBJECTDIR}/src/PerceptualMapping.o: src/PerceptualMapping.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PerceptualMapping.o src/PerceptualMapping.cpp

${OBJECTDIR}/src/Plotting.o: src/Plotting.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Plotting.o src/Plotting.cpp
...
${OBJECTDIR}/src/PointAndSurface.o: src/PointAndSurface.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PointAndSurface.o src/PointAndSurface.cpp

${OBJECTDIR}/src/Polygon.o: src/Polygon.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Polygon.o src/Polygon.cpp

${OBJECTDIR}/src/PolygonChoice.o: src/PolygonChoice.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PolygonChoice.o src/PolygonChoice.cpp

${OBJECTDIR}/src/StereoMapping.o: src/StereoMapping.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/StereoMapping.o src/StereoMapping.cpp

${OBJECTDIR}/src/Testboost.o: src/Testboost.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Testboost.o src/Testboost.cpp

${OBJECTDIR}/src/Transporter.o: src/Transporter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Transporter.o src/Transporter.cpp

${OBJECTDIR}/src/asr.o: src/asr.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/asr.o src/asr.cpp

${OBJECTDIR}/src/asrOp.o: src/asrOp.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/asrOp.o src/asrOp.cpp

${OBJECTDIR}/src/clipper.o: src/clipper.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/clipper.o src/clipper.cpp

${OBJECTDIR}/src/convertlog.o: src/convertlog.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/convertlog.o src/convertlog.cpp

${OBJECTDIR}/src/convexPathPlanner.o: src/convexPathPlanner.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/convexPathPlanner.o src/convexPathPlanner.cpp

${OBJECTDIR}/src/crossExits_test.o: src/crossExits_test.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/crossExits_test.o src/crossExits_test.cpp

${OBJECTDIR}/src/demo.o: src/demo.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/demo.o src/demo.cpp
...
${OBJECTDIR}/src/errorMap.o: src/errorMap.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/errorMap.o src/errorMap.cpp

${OBJECTDIR}/src/errorMapWholeFloor.o: src/errorMapWholeFloor.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/errorMapWholeFloor.o src/errorMapWholeFloor.cpp

${OBJECTDIR}/src/localmapAndglobal.o: src/localmapAndglobal.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/localmapAndglobal.o src/localmapAndglobal.cpp

${OBJECTDIR}/src/localmapGen.o: src/localmapGen.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/localmapGen.o src/localmapGen.cpp

${OBJECTDIR}/src/localmap_Generation.o: src/localmap_Generation.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/localmap_Generation.o src/localmap_Generation.cpp

${OBJECTDIR}/src/mapWholeFloor.o: src/mapWholeFloor.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mapWholeFloor.o src/mapWholeFloor.cpp

${OBJECTDIR}/src/mfisOp.o: src/mfisOp.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mfisOp.o src/mfisOp.cpp

${OBJECTDIR}/src/mrpt.o: src/mrpt.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mrpt.o src/mrpt.cpp
...
${OBJECTDIR}/src/offlineMapping.o: src/offlineMapping.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/offlineMapping.o src/offlineMapping.cpp

${OBJECTDIR}/src/readAndwriteASCII.o: src/readAndwriteASCII.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/readAndwriteASCII.o src/readAndwriteASCII.cpp

${OBJECTDIR}/src/robotControl.o: src/robotControl.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/robotControl.o src/robotControl.cpp

${OBJECTDIR}/src/segmentgeneration.o: src/segmentgeneration.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/segmentgeneration.o src/segmentgeneration.cpp

${OBJECTDIR}/src/space.o: src/space.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/space.o src/space.cpp

${OBJECTDIR}/src/thesis.o: src/thesis.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/thesis.o src/thesis.cpp

${OBJECTDIR}/src/wander.o: src/wander.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wander.o src/wander.cpp
